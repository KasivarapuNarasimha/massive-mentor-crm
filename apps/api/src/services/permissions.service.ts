...
export const MODULE_CATALOG: Array<{
  ...
  { key: "health", label: "Business Health Score", routePrefix: "/dashboard/health", apiPrefixes: ["/api/health-score"], category: "strategy", sortOrder: 16 },
  {
    key: "erp",
    label: "ERP",
    description: "Internal operations dashboard (Finance overview; no duplicate Finance CRUD)",
    routePrefix: "/dashboard/erp",
    apiPrefixes: ["/api/erp/dashboard"],
    category: "ops",
    sortOrder: 19,
  },
  {
    key: "erp_products",
    label: "ERP Products",
    routePrefix: "/dashboard/erp/products",
    apiPrefixes: ["/api/erp/products", "/api/erp/categories"],
    category: "ops",
    sortOrder: 191,
  },
  {
    key: "erp_inventory",
    label: "ERP Inventory",
    routePrefix: "/dashboard/erp/inventory",
    apiPrefixes: ["/api/erp/inventory", "/api/erp/warehouses", "/api/erp/stock-movements"],
    category: "ops",
    sortOrder: 192,
  },
  {
    key: "erp_vendors",
    label: "ERP Vendors",
    routePrefix: "/dashboard/erp/vendors",
    apiPrefixes: ["/api/erp/vendors"],
    category: "ops",
    sortOrder: 193,
  },
  {
    key: "erp_purchases",
    label: "ERP Purchases",
    routePrefix: "/dashboard/erp/purchases",
    apiPrefixes: [
  ...
  {
    key: "erp_sales",
    label: "ERP Sales Orders",
    routePrefix: "/dashboard/erp/sales-orders",
    apiPrefixes: ["/api/erp/sales-orders"],
    category: "ops",
    sortOrder: 195,
  },
...
export const ROLE_TEMPLATE_DEFAULTS: Array<{
  ...
  },
  {
    ...
    sortOrder: 6,
    modules: [
      "dashboard", "clients", "deals", "erp", "erp_products", "erp_inventory", "erp_vendors", "erp_purchases",
      "erp_sales", "finance", "reports", "approvals", "activity", "profile", "appearance",
    ],
  },
  {
    roleKey: "support",
