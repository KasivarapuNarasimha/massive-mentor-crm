  ...
  const portals: PortalDef[] = [
    ...
    },
    {
      ...
      menus: withCommon([
        ...
        menu("profile", "Business Profile", "/dashboard/profile", 17, ["config.edit"]),
        menu("activity", "Activity Logs", "/dashboard/activity", 18, ["audit.read"]),
      ]),
      actions: [
        ...
        { key: "media", label: "Media Library", type: "navigate", route: "/dashboard/media", order: 4 },
    ...
    },
    {
      ...
      description: "Full business management, CRM, strategy, and AI modules",
      roles: ["business_admin", "admin"],
      homeRoute: "/dashboard",
      defaultDashboardKey: "business_admin",
      menus: withCommon([
        menu("overview", "Dashboard", "/dashboard", 1),
        menu("profile", "Business Profile", "/dashboard/profile", 2, ["config.edit"]),
        menu("health", "Health Score", "/dashboard/health", 3),
        menu("swot", "SWOT Analysis", "/dashboard/swot", 4),
        menu("mentor", "AI Mentor", "/dashboard/mentor", 5, ["ai.use"]),
        menu("roadmap", "Growth Roadmap", "/dashboard/roadmap", 6),
        menu("leads", "Leads", "/dashboard/leads", 7, ["contacts.read"]),
        menu("clients", "Clients", "/dashboard/clients", 8, ["contacts.read"]),
        menu("deals", "Deals", "/dashboard/deals", 9, ["deals.read"]),
        menu("tasks", "Tasks", "/dashboard/tasks", 10, ["tasks.read"]),
        menu("meetings", "Meetings", "/dashboard/meetings", 11),
        menu("notes", "Notes", "/dashboard/notes", 12),
        menu("documents", "Documents", "/dashboard/documents", 13),
        menu("reports", "Reports", "/dashboard/reports", 14, ["reports.read"]),
        menu("ai_sales", "AI Sales", "/dashboard/ai-sales", 15, ["ai.use"]),
        menu("marketing_ai", "Marketing AI", "/dashboard/marketing", 16, ["ai.use"]),
        menu("finance", "Finance", "/dashboard/finance", 17, ["reports.read"]),
        menu("media", "Media Library", "/dashboard/media", 18),
        menu("whatsapp", "WhatsApp", "/dashboard/whatsapp", 19),
        menu("team", "Team & Roles", "/dashboard/team", 20, ["members.manage"]),
        menu("field_sales", "Field Sales Map", "/dashboard/field-sales", 21),
        menu("integrations", "Integrations", "/dashboard/integrations", 22, ["config.edit"]),
        menu("approvals", "Approvals", "/dashboard/approvals", 23),
        menu("billing", "Billing", "/dashboard/billing", 24),
        menu("backups", "Backups", "/dashboard/backups", 25),
        menu("activity", "Activity Logs", "/dashboard/activity", 26, ["audit.read"]),
      ]),
      actions: [
        ...
        { key: "media", label: "Media Library", type: "navigate", route: "/dashboard/media", order: 5 },
        { key: "field_sales", label: "Field Sales Map", type: "navigate", route: "/dashboard/field-sales", order: 6 },
        { key: "integrations", label: "Integrations", type: "navigate", route: "/dashboard/integrations", permission: "config.edit", order: 7 },
      ],
    ...
    },
    {
      ...
      actions: [
        ...
        { key: "media", label: "Media Library", type: "navigate", route: "/dashboard/media", order: 4 },
        { key: "field_sales", label: "Team Locations", type: "navigate", route: "/dashboard/field-sales", order: 5 },
      ],
    ...
    },
    {
      ...
      actions: [
        ...
        { key: "media", label: "Media Library", type: "navigate", route: "/dashboard/media", order: 2 },
        { key: "leads", label: "View Leads", type: "navigate", route: "/dashboard/leads", permission: "contacts.read", order: 3 },
      ],
