        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 sm:p-8">
          {sent ? (
            <div className="space-y-4 text-sm text-zinc-300">
              ...
              <div className="rounded-xl border border-emerald-800/40 bg-emerald-950/20 p-3 text-xs text-emerald-100/90 space-y-2">
                ...
                <p className="text-zinc-400">
                  ...
                  After changing SMTP settings, restart the API — <code className="text-zinc-300">tsx watch</code> does not reload{" "}
              ...
              <Link href="/login" className="inline-block text-white underline font-medium">
                Back to sign in
              </Link>
            </div>
          ) : (
            <form onSubmit={onSubmit} className="space-y-5">
              <div>
                <label htmlFor="fp-email" className="block text-sm text-zinc-300 mb-2">
                  Email address
                </label>
                <input
                  id="fp-email"
              ...
              <button
                type="submit"
                disabled={busy}
                className="w-full min-h-12 bg-white text-zinc-950 font-medium rounded-xl disabled:opacity-50"
              >
